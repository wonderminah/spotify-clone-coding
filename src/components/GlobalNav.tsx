  ...
  return (
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '50px' }}>
      ...
      <div style={{ display: 'flex' }}>
        <a href="/download" style={{ display: 'flex', columnGap: '8px',  height: '32px', alignItems: 'center', paddingLeft: '10px', paddingRight: '40px' }}>
          <svg style={{ fill: 'rgb(179, 179, 179)', width: '16px', height: '16px' }}>
            <path d="M4.995 8.745a.75.75 0 0 1 1.06 0L7.25 9.939V4a.75.75 0 0 1 1.5 0v5.94l1.195-1.195a.75.75 0 1 1 1.06 1.06L8 12.811l-.528-.528-.005-.005-2.472-2.473a.75.75 0 0 1 0-1.06"></path><path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8m8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13">
            </path>
          </svg>
          <span className="global__encore-text-body-small-bold">Install App</span>
        </a>
        <div style={{ display: 'flex', columnGap: '8px' }}>
          ...
          <button style={{ width: '32px', height: '32px' }}>
            <figure title="Mina Kim">
              <div>
                <img style={{ borderRadius: '50%' }} aria-hidden="false" draggable="false" loading="eager" src="https://platform-lookaside.fbsbx.com/platform/profilepic/?asid=1648241441935664&amp;height=50&amp;width=50&amp;ext=1758116795&amp;hash=AT8Lq3UP9JZ4O_u3xSFvx0zr" alt="Mina Kim"></img>
              </div>
            </figure>
          </button>
        </div>
